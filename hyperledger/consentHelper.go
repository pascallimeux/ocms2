...
func (c *Consent_Helper) GetVersion() (Response, error) {
...
func (c *Consent_Helper) GetTRConsent(consentID string) (Transaction, error) {
...
func (c *Consent_Helper) GetConsent(appID, consentID string) (Consent, error) {
...
func (c *Consent_Helper) GetAllConsents(appID string) ([]Consent, error) {
...
func (c *Consent_Helper) GetActivesConsents(appID string) ([]Consent, error) {
...
func (c *Consent_Helper) GetConsents4Consumer(appID, consumerID string) ([]Consent, error) {
...
func (c *Consent_Helper) GetConsents4Owner(appID, ownerID string) ([]Consent, error) {
...
func (c *Consent_Helper) UnactivateConsent(appID, consentID string) (Response, error) {
...
func extractConsent(response Response, err error) (Consent, error) {
	var consent Consent
	if err != nil {
		return consent, err
	}
...
func extractConsents(response Response, err error) ([]Consent, error) {
...
func extractTransactionUUID(response Response, err error) (string, error) {
	var uuid string
	if err != nil {
		return uuid, err
	}
...
func extractIsConsent(response Response, err error) (bool, error) {
	if err != nil {
		return false, err
	}
...
func extractStatusOK(response Response, err error) (bool, error) {
	if err != nil {
		return false, err
	}
	if response.IsOK() {
